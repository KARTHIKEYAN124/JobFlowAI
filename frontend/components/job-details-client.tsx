...
type Job = { id: string; title: string; company_name: string; location: string; remote_type: string; category: string; posted_at: string; description: string; application_url: string; required_skills: string[]; preferred_skills: string[] };
