...
import { BarChart3, Bell, Bot, BriefcaseBusiness, ChevronDown, CircleUserRound, FileStack, Gauge, Menu, Search, Settings, Sparkles, Target, Workflow, X } from "lucide-react";
...
const nav = [
  ["Dashboard", "/", Gauge], ["Jobs", "/jobs", BriefcaseBusiness], ["Matches", "/matches", Target],
