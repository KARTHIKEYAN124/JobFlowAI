...
export type Job = { id: string; title: string; company: string; location: string; score: number; skills: string[]; missing: string[]; posted: string; postedAt?: string; category: string; languages?: string[] };
