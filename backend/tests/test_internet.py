...
async def test_fetch_lever_job_uses_public_api(monkeypatch):
    monkeypatch.setattr(
        ...
        lambda url: {
            "text": "AI Engineer",
            "descriptionPlain": "Build Python systems",
            "categories": {"location": "Remote"},
            "hostedUrl": "https://jobs.lever.co/acme/abc",
            "createdAt": 1787652000000,
        },
    )
            ...
            "jobs": [
                {
                    ...
                    "descriptionHtml": "<p>Python infrastructure</p>",
                    "location": "Berlin",
...
async def test_fetch_smartrecruiters_job_uses_public_api(monkeypatch):
    monkeypatch.setattr(
        ...
        lambda url: {
            ...
            "jobAd": {"sections": {"description": {"text": "<p>Python and FastAPI</p>"}}},
        },
    )
